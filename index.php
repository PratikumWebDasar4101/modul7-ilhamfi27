	...
	<form action="proses_mahasiswa.php?aksi=input" method="post">
		<table>
			...
			<tr>
				...
				<td><input type="text" name="nama" pattern="[A-Za-z ]{1,50}" title="Nama Harus Lebih Dari 1 Karakter dan Kurang Dari 50 Karakter dan Tidak Mengandung Angka" required></td>
			</tr>
			<tr>
